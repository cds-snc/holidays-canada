...
INSERT INTO HOLIDAY (DATE_STRING, NAME_EN, NAME_FR) VALUES ('Second Monday in February', 'Family Day', 'Fête de la famille');
...
INSERT INTO HOLIDAY_PROVINCE (HOLIDAY_ID, PROVINCE_ID) VALUES ((SELECT ID FROM HOLIDAY WHERE (DATE_STRING = 'Second Monday in February' AND NAME_EN = 'Family Day')), 'BC');
INSERT INTO HOLIDAY_PROVINCE (HOLIDAY_ID, PROVINCE_ID) VALUES ((SELECT ID FROM HOLIDAY WHERE (DATE_STRING = 'Second Monday in February' AND NAME_EN = 'Family Day')), 'NB');
